...
const StatsPage = () => {
  ...
  return (
    <main className="max-w-4xl mx-auto p-6 md:p-12 min-h-screen">
      <h1 className="text-3xl font-bold text-[#244d3f] mb-2">Friendship Analytics</h1>
      <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm text-center">
        <p className="text-gray-500 mb-8 font-medium">By Interaction Type</p>

        {interactions.length === 0 ? (
          <div className="py-20 text-gray-400 italic font-medium">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart margin={{ top: 0, right: 0, bottom: 80, left: 0 }}>
                  ...
                  <Legend
                    ...
                    formatter={(value) => (
                      <span className="text-[16px] font-bold text-gray-600 px-2">{value}</span>
                    )}
                  />
                </PieChart>
              </ResponsiveContainer>
